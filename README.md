...
- ❗**Validación de entrada:** Si el campo de texto está vacío o contiene caracteres no válidos y si el nombre es repetido, el sistema mostrará una alerta solicitando un nombre válido.
