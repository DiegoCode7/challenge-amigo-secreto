...
- ❗**Validación de entrada:** Si el campo de texto está vacío o el nombre es repetido, el sistema mostrará una alerta solicitando un nombre válido o indicando que el nombre ya esta en la lista.
...
Sigue estos pasos para empezar a trabajar localmente.
